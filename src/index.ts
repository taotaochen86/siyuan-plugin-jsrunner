...
export default class SiyuanPluginJSRunner extends Plugin {
    ...
    onunload() {
        document.removeEventListener("mousedown", this.middleButtonClick);
        this.jsRunner.Stop();
    }
}
